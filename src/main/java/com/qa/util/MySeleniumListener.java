...
public class MySeleniumListener extends BaseClass implements WebDriverListener {
	...
	public void afterFindElement(WebDriver driver, By locator, WebElement result) {
		...
		logger.info("Found element " + locator.toString());
	}
	...
	public void beforeSendKeys(WebElement element, CharSequence... keysToSend) {
		...
		logger.info("Sending keys " + keysToSend.toString() + " to element: " + element.toString());
	}

	public void afterSendKeys(WebElement element, CharSequence... keysToSend) {
		System.out.println("Sent keys " + keysToSend.toString() + " to element: " + element.toString());
		logger.info("Sent keys " + keysToSend.toString() + " to element: " + element.toString());
	}
	...
	public void beforeChangeValueOf(WebElement element, WebDriver driver) {
		...
		logger.info("Value of the " + element.toString() + " before any chagnes made");
	}
